\section{Marco teórico}
    ...
    \subsection{Mantenimiento industrial}
        ...
        \subsubsection{Mantenimiento preventivo}\label{subsec:preventive_maintenance}
            ...
            El mantenimiento preventivo se define con base en el periodo de tiempo previo a que ocurra la falla de un equipo, disminuyendo acciones correctivas que comprometen la disponibilidad de estos. Básicamente, el mantenimiento preventivo “consiste en programar inspecciones y revisiones a los equipos o máquinas, apoyándose en el conocimiento de estas con base en la experiencia de los ingenieros o técnicos, así también como el historial de la máquina” \parencite[p. 12]{TOLEDO:2018}.
    ...
    \subsection{Modelos 3D y su integración con la realidad aumentada}
        ...
        El modelado 3D constituye una base fundamental para el desarrollo de experiencias de realidad aumentada. Se trata de una representación tridimensional de un objeto mediante software especializado cuyo proceso inicia desde la adquisición de datos y culmina con un modelo virtual visualmente interactivo a través de una computadora \parencite{GHUGE:2023}.
