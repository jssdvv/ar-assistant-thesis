\section{Desarrollo del aplicativo de realidad aumentada}
    ...
    \subsection{Diseño de la base de datos}
        ...
        El diseño de la base de datos está basado en SQLite con el uso de la librería Room para Android, estructurándose en tablas de entidades y tablas intermedias según la naturaleza de los datos almacenados.

        \subsubsection{Tablas de entidades}
            ...
            \paragraph{Entidades de información técnica.} Almacenan los datos de identificación y especificaciones técnicas de la máquina y su motor eléctrico. Cada equipo separa su información en dos tablas: una de identidad y otra de especificaciones, dado el volumen de atributos que cada una maneja. Adicionalmente, se incluye una entidad para los documentos PDF vinculados a cada máquina.

                \input{assets/figures/second_phase/entity/fig_entity_machine_and_specs.tex}

                \input{assets/figures/second_phase/entity/fig_entity_motor_and_specs.tex}

                \input{assets/figures/second_phase/entity/fig_entity_document.tex}

            \paragraph{Entidades de realidad aumentada.} Almacenan los datos de los elementos aumentados vinculados a cada máquina: los marcadores físicos que activan la experiencia AR y los modelos 3D superpuestos. Ambas entidades incluyen offsets de posición y rotación expresados en coordenadas cartesianas y cuaterniones, necesarios para su calibración espacial.

                \input{assets/figures/second_phase/entity/fig_entity_marker.tex}

                \input{assets/figures/second_phase/entity/fig_entity_model.tex}

            \paragraph{Entidades de procesos de mantenimiento.} Conforman una cadena jerárquica que estructura los procedimientos de mantenimiento: una actividad agrupa pasos ordenados, cada paso contiene operaciones que definen las animaciones 3D ejecutadas sobre los modelos durante la experiencia de realidad aumentada.

                \input{assets/figures/second_phase/entity/fig_entity_activity.tex}

                \input{assets/figures/second_phase/entity/fig_entity_step.tex}

                %\input{assets/figures/second_phase/entity/fig_entity_operation.tex}

            \paragraph{Entidades de catálogo.} Almacenan datos reutilizables globalmente, sin vínculo directo a una máquina en particular. En este caso, el catálogo de herramientas disponibles durante las actividades de mantenimiento, cada una con representación visual vectorial según su tipo.

                %\input{assets/figures/second_phase/entity/fig_entity_tool.tex}

            \paragraph{Entidad de cronograma.} Almacena los eventos de mantenimiento programados, cada uno vinculado a una actividad específica del subsistema de máquinas. Gestiona la recurrencia y la programación temporal de dichos eventos.

                %\input{assets/figures/second_phase/entity/fig_entity_event.tex}
