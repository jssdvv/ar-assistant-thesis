    ...
    \subsection{Pruebas de funcionamiento de las pantallas}
        ...
        \subsubsection{Funcionamiento de las pantallas de configuración previa de realidad aumentada}
            ...
            \paragraph{Pantalla de calibración de modelos 3D}
                ...
                Una vez que el marcador ha sido detectado correctamente, se habilitan las funciones de calibración de modelos. A partir de ese momento, se seleccionó un modelo 3D y, mediante los controles de reposicionamiento, se ajusta su ubicación y orientación de acuerdo con la posición real de la máquina (ver Figura \ref{fig:func_calibration}).
            ...
            \paragraph{Pantalla de editor de actividades de mantenimiento}
                ...
                Una vez creado el paso, el usuario puede definir las operaciones que describen el movimiento de los submodelos 3D. Como se muestra en la Figura \ref{fig:func_operations}, primero se selecciona las partes que participarán en la animación, junto a su tipo de operacion (ver Tabla \ref{tab:operations}), el cual habilita diferentes casillas de parámetros para configurar el movimiento que ejecutará cada entidad del modelo tridimensional.
