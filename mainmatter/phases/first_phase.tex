\section{Definición de requerimientos y restricciones}
    ...
    \subsection{Creación de redes semánticas}
        ...
        Sin embargo, se propusieron conectores personalizados (Figura \ref{fig:relations_proposed}) para representar con mayor precisión las relaciones entre los códigos, las funcionalidades propuestas y los aspectos del mantenimiento preventivo asociados a cada panel, con el fin de explorar qué su integración en el aplicativo de realidad aumentada.
    ...
    \subsection{Requerimientos de la aplicación}
        ...
        \subsubsection{Panel de cronograma de eventos}
            ...
            En este panel, el usuario tiene la capacidad de registrar anotaciones relacionadas con las fechas de las intervenciones de mantenimiento, lo que facilita el control y cumplimiento de su periodicidad. Adicionalmente, se integra un sistema de notificaciones para alertar sobre la proximidad de las tareas programadas, propiciando su ejecución puntual y contribuyendo a una mejor organización del tiempo. Con base en la revisión teórica, los datos principales a registrar y presentar son:
