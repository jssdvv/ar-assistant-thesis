\section{Definición de requerimientos y restricciones}
    ...
    \subsection{Identificación de patrones}
        ...
        Para el análisis de datos cualitativos se desarrolló una entrevista (Apéndice \ref{apc:qualitative_analysis_interview}) orientada a recopilar datos y conceptos aportados por personas vinculadas profesionalmente al mantenimiento industrial, quienes participaron de manera voluntaria. El propósito fue identificar características a incluir en el aplicativo móvil de realidad aumentada y en la gestión de la información para el mantenimiento preventivo. La información obtenida fue sometida a un proceso sistemático de codificación, categorización y síntesis, que permitió no solo identificar patrones recurrentes, sino también revelar particularidades relevantes para el desarrollo del aplicativo.

        Las entrevistas fueron registradas y sus respuestas anonimizadas antes del análisis, siendo empleadas exclusivamente con fines académicos. En ellas, se buscó que los participantes respondieran a partir de su experiencia en el área de mantenimiento, su familiaridad con las tecnologías de la información y la comunicación (TIC) y la realidad aumentada, así como de su conocimiento sobre deficiencias organizacionales y conceptos asociados al mantenimiento preventivo. El estudio se limitó a la recopilación de opiniones técnicas, sin intervención alguna sobre los participantes ni recolección de datos personales sensibles.

    \subsection{Categorización y codificación}

        Se generó un conjunto de categorías a las cuales se les relacionarían posteriormente frases o citas de la transcripción de las entrevistas buscando con esto clasificar y organizar la información para facilitar la identificación de patrones y vínculos conceptuales. \textcite{RODRIGUEZ:2005} mencionan que este proceso de categorización se puede realizar mediante un enfoque deductivo, con base en categorías establecidas previamente a la lectura del material; un enfoque inductivo, donde las categorías están establecidas a partir de la lectura y examen del material; o aplicando ambos (enfoque mixto). Para el desarrollo del análisis se consideró la generación de las categorías después de realizar la lectura del texto.
        ...
        \begin{itemize}
            ...
            \item \textbf{Perfil del entrevistado:} Reúne información relacionada con la experiencia en el área del mantenimiento de los entrevistados, los conocimientos desarrollados a partir de esa experiencia y la familiaridad que tienen con herramientas tecnológicas en dicho contexto.
    ...
    \subsection{Creación de redes semánticas}
        ...
        A partir de los códigos obtenidos durante el análisis cualitativo, se generaron redes semánticas para cada uno de los paneles identificados en las entrevistas. Estas estructuras presentan un patrón característico que permite vincular diversos nodos y representar cómo se interrelacionan varios conceptos \parencite{PEREZ:2022}.
    ...
    \subsection{Co-ocurrencia de datos}
        ...
        \subsubsection{Diagramas Sankey}
            ...
            \paragraph{Diagrama de co-ocurrencia entre aspectos y funcionalidades de mantenimiento}
                ...
                Este diagrama, ilustrado en la Figura \ref{fig:sankey_coocurrence_functionalities_aspecs}, muestra la relación entre las funcionalidades (representadas en naranja) y los distintos aspectos del mantenimiento (en azul), donde se observa un patrón de convergencia que reúne múltiples aspectos de mantenimiento en una misma funcionalidad, lo cual podría indicar que dicha funcionalidad es un elemento central para el diseño y la experiencia de los usuarios, al ser considerado desde diferentes puntos.
            ...
            \paragraph{Diagrama de co-ocurrencia entre paneles y funcionalidades}
                ...
                El diagrama de Sankey de la Figura \ref{fig:sankey_coocurrence_panels_functionalities} muestra las conexiones entre los paneles propuestos en las entrevistas (representados en verde) y las funcionalidades (en naranja). En dicho diagrama, se observa un patrón de divergencia en el que los paneles de mayor densidad se vinculan con múltiples funcionalidades, lo cual podría indicar que estas son secciones relevantes para ser incorporadas en el desarrollo de la aplicación de realidad aumentada.
    ...
    \subsection{Requerimientos de la aplicación}
        ...
        A partir del análisis cualitativo de las entrevistas, en conjunto con los lineamientos de las normas revisadas en el marco teórico, se establecieron los requerimientos funcionales, materializados en los paneles que conformarán la interfaz de la aplicación de realidad aumentada.
        ...
        \subsubsection{Panel para la ejecución de procedimientos}
            ...
            Esta sección opera como una guía para la realización asistida de las diversas actividades de mantenimiento mediante el uso de realidad aumentada, donde se definieron las siguientes funcionalidades principales:
    ...
    \subsection{Requerimientos no funcionales}
        ...
        Como requerimientos no funcionales se establecieron las siguientes restricciones y condiciones para el desarrollo del aplicativo de realidad aumentada.

        \begin{enumerate}

            \item \textbf{Compatibilidad del sistema operativo:} La aplicación deberá ser compatible con dispositivos que ejecuten Android 9 o versiones superiores.

            \item \textbf{Independencia de red:} La aplicación deberá operar sin conexión a Internet durante la ejecución de sus funcionalidades, garantizando la disponibilidad local de los recursos necesarios.

            \item \textbf{Reconocimiento espacial:} La aplicación deberá implementar el reconocimiento de marcadores físicos mediante rastreo de imágenes para el despliegue de los elementos de realidad aumentada, sin depender de modelos de aprendizaje automático.

            \item \textbf{Compatibilidad tridimensional:} La aplicación deberá admitir exclusivamente modelos tridimensionales en formato binario glTF (.glb) para su carga y visualización.

            \item \textbf{Soporte multimedia:} La aplicación deberá admitir únicamente imágenes estáticas como recursos bidimensionales, excluyendo el procesamiento y reproducción de contenido audiovisual.

            \item \textbf{Usabilidad:} La interfaz de usuario deberá ser consistente, intuitiva y de fácil utilización para técnicos con conocimientos básicos en el manejo de dispositivos móviles.
