\section{Desarrollo del aplicativo de realidad aumentada para mantenimiento}
    ...
    \subsection{Diseño de la lógica de negocio y subsistemas}
        ...
        A partir de los requerimientos establecidos mediante las encuestas y los referentes bibliográficos, el aplicativo fue estructurado en subsistemas, también conocidos como paquetes. Lo anterior se muestra en la Figura \ref{fig:subsystems}.
    ...
    \subsection{Diseño de las interfaces gráficas}
        ...
        \subsubsection{Diseño de las pantallas de información técnica}
            ...
            \paragraph{La pantalla de especificaciones}
                ...
                Como se observa en la Figura \ref{fig:screen_specs}, la información se presenta mediante tarjetas temáticas presentes en los Apéndices \ref{machine_cards} y \ref{motor_cards}.
