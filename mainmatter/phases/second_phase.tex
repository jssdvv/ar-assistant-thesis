\section{Desarrollo del aplicativo de realidad aumentada para mantenimiento}
    ...
    \subsection{Formatos de los archivos}
    ...
    \subsection{Descomposición de marcadores}

        Los marcadores utilizados en el aplicativo fueron diseñados con base en códigos QR, generados y exportados directamente desde la propia aplicación. Cada marcador está asociado a una máquina y posición específica, permitiendo un número ilimitado de marcadores por máquina registrada.

        Estructuralmente, cada marcador consiste en un rectángulo con un margen externo que organiza dos zonas: la parte superior contiene el código QR y la parte inferior su decodificación en texto, siguiendo la nomenclatura \textit{MxPy}, donde \textit{M} indica la máquina con su identificador numérico y \textit{P} indica la posición con su índice correspondiente, permitiendo distinguir múltiples marcadores asociados a una misma máquina (ver Figura \ref{fig:markers_decomposition}). Por ejemplo, \textit{M1P1} corresponde al primer marcador de la máquina con identificador 1 y posición con índice 1.

        \input{assets/figures/second_phase/fig_markers_decomposition.tex}
    ...
    \subsection{Nodos de la escena}
        ...
        \subsubsection{Sistema de colores}

            Se implementó un sistema de colores para representar los diferentes estados de los modelos tridimensionales durante la edición de actividades y su interacción en las animaciones. Como se muestra en la Figura \ref{fig:models_colors}, este sistema reemplaza todo material definido originalmente en los archivos \textit{.glb}, garantizando una representación visual uniforme y consistente de los estados de los modelos, independientemente de la máquina o del material asignado durante su proceso de modelado CAD.

            \input{assets/figures/second_phase/fig_models_colors.tex}

        \subsubsection{Sistema de coordenadas de los nodos}

            El sistema de coordenadas global corresponde al espacio de referencia principal de la escena de realidad aumentada, sobre el cual se determina la posición absoluta de todos los elementos. En contraste, cada nodo define sus transformaciones de posición, rotación y escala mediante un sistema de coordenadas local, establecido con respecto a su nodo padre dentro de la jerarquía de la escena. Esta organización permitió conservar las relaciones espaciales entre nodos padre e hijo, de manera que las transformaciones aplicadas a un nodo padre se propagaran automáticamente a sus descendientes, mientras que los ajustes individuales pudieran realizarse modificando únicamente las coordenadas locales de cada nodo. La representación de los sistemas de coordenadas global y local se muestra en las Figura \ref{fig:coordinate_system_comparison}.
        ...
        \subsubsection{Nodos de jerarquía espacial}
            ...
            \paragraph{Nodo de contenedor.}
                ...
                \input{assets/figures/second_phase/node/fig_node_container.tex}
            ...
            \paragraph{Nodo de pivote.}
                ...
                \input{assets/figures/second_phase/node/fig_node_pivots.tex}
    ...
    \subsection{Diseño de las interfaces gráficas}
        ...
        La interfaz del aplicativo está conformada por un conjunto de pantallas organizadas según el flujo de navegación de la Figura \ref{fig:uml_navigation_state}. Asimismo, incorpora componentes reutilizables que mantienen la consistencia visual y funcional entre las diferentes secciones del sistema. El código fuente puede consultarse en el Apéndice \ref{apc:github}. En los siguientes apartados se describen los principales componentes de la interfaz y la organización de las pantallas que conforman el aplicativo.
        ...
        \subsubsection{Diseño de las pantallas de la navegación principal}
            ...
            \paragraph{La pantalla de escáner}
                ...
                \input{assets/figures/second_phase/screen/fig_screen_scanner.tex}
            ...
            \paragraph{La pantalla de máquinas}
                ...
                \input{assets/figures/second_phase/screen/fig_screen_machines.tex}
            ...
            \paragraph{La pantalla de herramientas}
                ...
                \input{assets/figures/second_phase/screen/fig_screen_tools.tex}
            ...
            \paragraph{La pantalla de eventos}
                ...
                \input{assets/figures/second_phase/screen/fig_screen_events.tex}
        ...
        \subsubsection{Diseño de las pantallas de información técnica}
            ...
            \paragraph{La pantalla de especificaciones}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_specs.tex}
            ...
            \paragraph{La pantalla de documentación}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_documents.tex}
            ...
            \paragraph{La pantalla de actividades de mantenimiento}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_activities.tex}
        ...
        \subsubsection{Diseño de las pantallas de configuración previa de realidad aumentada}
            ...
            \paragraph{Pantalla de marcadores}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_markers.tex}
            ...
            \paragraph{Pantalla de calibración de modelos 3D}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_calibration.tex}
                ...
                \input{assets/figures/second_phase/controls/fig_calibration_controls.tex}
            ...
            \paragraph{Pantalla de editor de actividades de mantenimiento}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_editor.tex}
                ...
                \input{assets/figures/second_phase/secondary_screen/fig_screen_editor_parts_list.tex}

                \input{assets/figures/second_phase/secondary_screen/fig_screen_editor_steps_list.tex}

                Cada actividad se organiza en una serie de pasos, los cuales pueden contener una o varias operaciones encargadas de definir las animaciones de los submodelos seleccionados. Para ello el usuario deberá primero crear los pasos mediante el diálogo mostrado en la Figura \ref{fig:steps_dialog}, que habilitará la creación de operaciones que incorpora un panel inferior expandible, ilustrado en la Figura \ref{fig:operation_controls}, donde se seleccionará cuales submodelos serán animados de forma conjunta mediante su tipo de operación: punto a punto, cilíndrica, junta y tornillo, cada una diseñada para representar diferentes comportamientos mecánicos.

                \input{assets/figures/second_phase/controls/fig_steps_dialog.tex}

                \input{assets/figures/second_phase/controls/fig_operation_controls.tex}
                ...
                \input{assets/tables/third_phase/tab_operations.tex}
        ...
        \subsubsection{Diseño de la pantalla final de sesión de realidad aumentada}
            ...
            \input{assets/figures/second_phase/secondary_screen/fig_screen_arsession.tex}
    ...
    \subsection{Secuencias de los procedimientos de configuración}
        ...
        \subsubsection{Secuencia para la calibración de modelos 3D}
            ...
            \input{assets/figures/second_phase/sequence/fig_sequence_model_calibration.tex}
        ...
        \subsubsection{Secuencia para la edición de una actividad de mantenimiento}
            ...
            \input{assets/figures/second_phase/sequence/fig_sequence_activity_edition.tex}