\begin{ThreePartTable}
    ...
    \begin{TableNotes}
        \item \textbf{Nota.} En todas las operaciones, la posición inicial corresponde a la posición final de la operación anterior o, en ausencia de una operación previa, a la posición original del modelo tridimensional.
    \end{TableNotes}
