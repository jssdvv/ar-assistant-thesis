\begin{ThreePartTable}
    ...
    \begin{TableNotes}
        \item \textit{Nota.} Adaptado de \textit{Industrias del petróleo, petroquímicas y del gas natural. Recogida e intercambio de datos de mantenimiento y fiabilidad de los equipos} (p. 44), por Asociación Española de Normalización y Certificación, 2016, AENOR. Traducción de los autores.
\end{TableNotes}
